...
- `probabil-2025` - Probabilistic Methods in Computer Science, in the 2025/26 lecture order
- `probabil-egzamin` - 2025/26 Probabilistic Methods in Computer Science exam questions with answers
