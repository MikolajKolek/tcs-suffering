...
\begin{proof}
    ...
    Wynika z tego, że \( (k - j) \cdot 1 = 0 \), więc mamy skończoną dodatnią charakterystykę.
...
\begin{theorem}
	Ciało skończone \( \mathbb{F} \)  o charakterystyce \( p \in \mathbb{P} \) ma \( p^k \) elementów dla pewnego \( k \in \integer \).
\end{theorem}
\begin{proof}
