...
\begin{proof}
	...
	Załóżmy nie wprost, że \( \mathbb{Z}_p[X]/W \) jest ciałem i \( W \) jest rozkładalny, czyli można zapisać \linebreak \( W = g_1 \cdot g_2 \), gdzie \( 1 \leq \deg(g_1), \deg(g_2) < \deg(W) \).
	Wynika z tego, że \( g_1 \cdot g_2 = 0 \), czyli \( g_1, \ g_2 \) są dzielnikami zera w tym ciele. Nie mają więc odwrotności względem mnożenia (bo inaczej \(0 = (g_1 \cdot g_2) \cdot g_1^{-1} = g_2\)), co daje sprzeczność.
