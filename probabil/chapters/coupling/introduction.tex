...
\begin{example}
	...
	\end{itemize}
	Niech \(X_0\) to pewna ustalona permutacja początkowa, a \(X_n\) to permutacja kart po \(n\) krokach. Możemy zauważyć, że \((X_n)_{n \in \natual}\) jest skończonym, nieprzywiedlnym oraz nieokresowym (bo możemy wziąć kartę z wierzchu) łańcuchem Markowa, a więc ma rozkład stacjonarny \((\pi_x)_{x \in S}\).
