%<*probabil-2025-11-07-aproksymacja-poissona>
%<*probabil-egzamin-aproksymacja-poissona>
...
\begin{proof}
	...
	Ostatnie przejście wynika z \(m! < e \sqrt{m} \pars{\frac{m}{e}}^m\), czego nie będziemy dowodzić.
\end{proof}
%</probabil-2025-11-07-aproksymacja-poissona>

\subsection{Kule i urny}
%<*probabil-2025-11-14-kule-i-urny-lower-bound>
...
\begin{theorem}[Lemat 5.12 P\&C]
	\label{balls-and-bins-max-load-lower-bound}
	Dla wystarczająco dużego \(n\), jeśli wrzucamy \( n \) kul do \( n \) urn
...
\begin{proof}
	...
	W takim razie, prawdopodobieństwo, że ustalona urna zawiera co najmniej \( M \) kul wynosi
	\[
...
%<*probabil-2025-11-14-kolekcjoner-kuponow>
...
%<*probabil-egzamin-kolekcjoner-kuponow-granica>
\begin{theorem}
...
\begin{proof}
	...
	\begin{align*}
		...
		P(\mathcal{E} \mid \abs{X - m} > \delta) \cdot o(1)                                           \\
		 ...
		 & = \lim_{n \to \infty} P(\mathcal{E} \mid X = m)
	\end{align*}
