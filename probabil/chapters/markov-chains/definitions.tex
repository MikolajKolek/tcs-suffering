...
\begin{definition}
	...
	\[
		\prob(X_t = a_t \mid X_{t-1} = a_{t-1}, X_{t-2} = a_{t-2}, \dots X_0 = a_0) =
		\prob(X_t = a_t \mid X_{t-1} = a_{t-1})
	\]
\end{definition}

\begin{definition}
	\textbf{Łańcuchem Markowa} nazywamy proces Markowa z czasem dyskretnym.
\end{definition}
...
\begin{definition}
	...
	\prob(X_t = a_t \mid X_{t-1} = a_{t-1} \land t = t_0) = \prob(X_t = a_t \mid X_{t-1} = a_{t-1})
	\)
\end{definition}
