...
\begin{theorem}
	Oczekiwana liczba kroków \(\expected{T^+_\ell \mid X_0 = \ell - 1}\) do stanu \(\ell\) zaczynając w \(\ell - 1\) jest równa \(\frac{1}{q_\ell w_\ell}\sum_{j=0}^{\ell-1}w_j\).
\end{theorem}
\begin{proof}
	Rozważmy najpierw restrykcję tego łańcucha do stanów \(\set{0, \dots, \ell}\). Łańcuch ten ma nowy rozkład stacjonarny \(\widetilde{\pi}_k = \frac{w_k}{\sum_{j=0}^\ell w_j}\).
	Obliczamy czas powrotu z \(\ell\) do \(\ell\).
	\[
		\expected{\widetilde{T}^+_\ell \mid \widetilde{X}_0 = \ell} = (p_\ell + r_\ell) \cdot 1 + (q_\ell)\left[\expected{\widetilde{T}^+_\ell \mid \widetilde{X}_0 = \ell-1} + 1\right] = 1 + q_\ell \expected{T_\ell^+ \mid X_0 = \ell - 1}
	\]
	\[
		\expected{\widetilde{T}^+_\ell \mid \widetilde{X}_0 = \ell} = \frac{1}{\widetilde{\pi}_\ell} = \frac{1}{w_\ell}\sum_{j=0}^l w_j
	\]
	\[
		\expected{T_\ell^+ \mid X_0 = \ell - 1} = \frac{1}{q_\ell}\pars{\expected{\widetilde{T}^+_\ell \mid \widetilde{X}_0 = \ell} - 1} = \frac{1}{q_\ell}\pars{\frac{1}{w_\ell}\sum_{j=0}^l w_j - 1} = \frac{1}{q_\ell w_\ell}\sum_{j=0}^{\ell-1}w_j
	\]
\end{proof}
