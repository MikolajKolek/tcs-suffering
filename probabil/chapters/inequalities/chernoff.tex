...
\begin{theorem}
	...
	Niech \(X_1,\ldots,X_n\) będą niezależnymi zmiennymi takimi, że \(P \pars{ X_i = 1 } = p_i\) oraz \(P \pars{ X_i = 0 } = 1-p_i\). Niech \(X = \sum_{i=1}^{n} X_i\), \(\mu = \mathbb{E}\left[ X \right] \) Wtedy dla każdego \(\delta \in (0,1)\) zachodzi:
	\begin{enumerate}
